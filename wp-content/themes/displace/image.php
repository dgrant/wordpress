		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="entry-content">
				...
				<div class="entry-attachment">
					<?php displace_the_attached_image(); ?>
			...
			<footer class="entry-meta">
				<?php
					...
					printf( '<div class="icon icon-image">' . __( 'Full resolution: <a href="%1$s" title="Link to full-size image">%2$s &times; %3$s</a>', 'displace' ) . '</div>',
